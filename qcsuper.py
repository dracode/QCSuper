...
from inputs.android import AndroidConnector
...
input_mode.add_argument('--android', action = 'store_true', help = 'Running on the android device directly, not connected via ADB.')
